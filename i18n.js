...
const translations = {
  en: {
    ...
    no_kinds_selected: "No exercise types selected.",
    no_training_that_day: "No training logged",
  ...
  he: {
    ...
    no_kinds_selected: "לא נבחרו סוגי אימונים.",
    no_training_that_day: "לא נרשם אימון",
